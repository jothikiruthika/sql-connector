...
> * [Element Template](./element-templates/postgresql-connector.json)
...
The element templates can be found in the [element-templates/template-connector.json](element-templates/postgresql-connector.json) file.
